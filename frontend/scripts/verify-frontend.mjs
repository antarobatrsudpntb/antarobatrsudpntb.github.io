...
check(sw.includes("melesat-shell-produksi-v1") && sw.includes('event.request.method !== "GET"') && sw.includes("url.origin !== self.location.origin"), "service worker Produksi V1 versioned dan hanya cache GET same-origin");
